🚀 AI-Powered Personalized Finance Assistant
🏆 Team Members
[Joshith Reddy Aleti]
...
Chart.js – Used for real-time financial visualizations (pie charts, bar graphs, and spending analysis).
Google Fonts – Used to improve typography and UI readability.
JavaScript Local Storage – Used for storing user transactions, budgets, and predictions persistently.
